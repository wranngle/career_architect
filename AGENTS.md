...
<!-- dotfiles-import: CLAUDE.md sha256:4fc139d7286a47688d65d1692a75e09adc074b2cf4abf9ab35d43127db935ce4 -->
# CLAUDE.md (CareerArchitect fork)

> **This fork** of [santifer/career-ops](https://github.com/santifer/career-ops) adds
> a Next.js landing page (`src/`) and a few coverage extensions. Everything
> below this box is upstream verbatim and MUST stay that way — `test-all.mjs`
> asserts CLAUDE.md sections, and skill modes reference them by name. Put fork
> customizations into the files below, not into this document.
>
> **Fork-only additions (none of these come from upstream):**
>
> | File | Purpose |
> |---|---|
...
> | `scripts/google_jobs_serp.py` | Google Jobs aggregator via SERP API (Tier 1c) |
...
> from them. See `UPSTREAM.md` for the full not-ported list.
>
> | Section in this file | Missing on disk |
> |---|---|
...
>
> **Upstream sync:** the rest of this file is upstream at SHA `b8a3a12`. See
> `UPSTREAM.md` for what was ported and what was skipped.
...
| Wants daily autonomous scan + rank + auto-eval loop | `autopilot` |
| Wants to recalibrate scoring weights from past outcomes | `learn` |
