...
> Report fork-specific bugs and feature ideas on
> [this repo's issue tracker](https://github.com/wranngle/career_architect/issues).
> The channels below belong to the upstream
> [santifer/career-ops](https://github.com/santifer/career-ops) project and
> are for upstream questions — don't report fork-specific problems there.
