# UI Constraints — Uncodixfy Ruleset

> Sourced from [cyxzdev/Uncodixfy](https://github.com/cyxzdev/Uncodixfy), MIT License 2026 — verbatim copy with repo-specific color annotation.
>
...
> **Tier-1 (this repo): `tokens/tokens.css`** — exhaust `--sunset-*`, `--violet-*`, `--sand-*`, `--night-*` primitives and semantic aliases (`--color-action`, `--surface-card`, `--text-primary`, etc.) before consulting the palettes below.
